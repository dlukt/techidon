...
public class UsableRecyclerView extends RecyclerView implements ObservableListImageLoaderAdapter, EmptyViewCapable{
	...
	public void addFooterView(View view){
		...
		if(footerAdapter==null){
			RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter=getWrappedAdapter();
			footerAdapter=new FooterRecyclerAdapter(adapter);
			footerAdapter.setHasStableIds(adapter.hasStableIds());
			super.setAdapter(footerAdapter);
		}
	}

	@SuppressWarnings("unchecked")
	private RecyclerView.Adapter<? extends RecyclerView.ViewHolder> getWrappedAdapter(){
		return (RecyclerView.Adapter<? extends RecyclerView.ViewHolder>) getAdapter();
	}
	...
	private class FooterRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
		private RecyclerView.Adapter<? extends RecyclerView.ViewHolder> wrapped;
		private static final int FOOTER_TYPE_FIRST=-1000;

		public FooterRecyclerAdapter(RecyclerView.Adapter<? extends RecyclerView.ViewHolder> wrapped){
		...
		public void onBindViewHolder(ViewHolder holder, int position) {
			if(position<wrapped.getItemCount())
				bindViewHolder(wrapped, holder, position);
		}
		...
		public boolean onFailedToRecycleView(ViewHolder holder) {
			if(!(holder instanceof FooterViewHolder))
				return failedToRecycle(wrapped, holder);
			return false;
		}
		...
		public void onViewAttachedToWindow(ViewHolder holder) {
			if(!(holder instanceof FooterViewHolder))
				onViewAttached(wrapped, holder);
		}

		@Override
		public void onViewDetachedFromWindow(ViewHolder holder) {
			if(!(holder instanceof FooterViewHolder))
				onViewDetached(wrapped, holder);
		}

		@Override
		public void onViewRecycled(ViewHolder holder) {
			if(!(holder instanceof FooterViewHolder))
				onViewRecycled(wrapped, holder);
		}
		...
		@SuppressWarnings("unchecked")
		private static <VH extends RecyclerView.ViewHolder> boolean failedToRecycle(RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, RecyclerView.ViewHolder holder){
			return ((RecyclerView.Adapter<VH>) adapter).onFailedToRecycleView((VH) holder);
		}

		@SuppressWarnings("unchecked")
		private static <VH extends RecyclerView.ViewHolder> void onViewAttached(RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, RecyclerView.ViewHolder holder){
			((RecyclerView.Adapter<VH>) adapter).onViewAttachedToWindow((VH) holder);
		}

		@SuppressWarnings("unchecked")
		private static <VH extends RecyclerView.ViewHolder> void onViewDetached(RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, RecyclerView.ViewHolder holder){
			((RecyclerView.Adapter<VH>) adapter).onViewDetachedFromWindow((VH) holder);
		}

		@SuppressWarnings("unchecked")
		private static <VH extends RecyclerView.ViewHolder> void onViewRecycled(RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, RecyclerView.ViewHolder holder){
			((RecyclerView.Adapter<VH>) adapter).onViewRecycled((VH) holder);
		}
	}
