...
* [Adding the ability to view other server's local timelines](https://github.com/deicod/techidon/tree/feature/local-timelines)
* [Adding the ability to load followers and following from remote instance](https://github.com/deicod/techidon/tree/feature/remote-followers)
* [Adding the ability to have filtered posts show with a warning](https://github.com/deicod/techidon/tree/feature/filters_again)
