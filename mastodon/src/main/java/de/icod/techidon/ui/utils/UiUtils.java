...
import static de.icod.techidon.GlobalUserPreferences.ThemePreference.*;
import static de.icod.techidon.GlobalUserPreferences.theme;
import static de.icod.techidon.GlobalUserPreferences.trueBlackTheme;
...
import de.icod.techidon.FileProvider;
import de.icod.techidon.GlobalUserPreferences;
import de.icod.techidon.MastodonApp;
import de.icod.techidon.R;
import de.icod.techidon.api.MastodonAPIRequest;
import de.icod.techidon.api.MastodonErrorResponse;
import de.icod.techidon.api.StatusInteractionController;
import de.icod.techidon.api.requests.accounts.SetAccountBlocked;
import de.icod.techidon.api.requests.accounts.SetAccountFollowed;
import de.icod.techidon.api.requests.accounts.SetAccountMuted;
import de.icod.techidon.api.requests.accounts.SetDomainBlocked;
import de.icod.techidon.api.requests.search.GetSearchResults;
import de.icod.techidon.api.requests.accounts.AuthorizeFollowRequest;
import de.icod.techidon.api.requests.accounts.RejectFollowRequest;
import de.icod.techidon.api.requests.instance.GetInstance;
import de.icod.techidon.api.requests.lists.DeleteList;
import de.icod.techidon.api.requests.notifications.DismissNotification;
import de.icod.techidon.api.requests.statuses.CreateStatus;
import de.icod.techidon.api.requests.statuses.DeleteStatus;
import de.icod.techidon.api.requests.statuses.GetStatusByID;
import de.icod.techidon.api.requests.statuses.SetStatusMuted;
import de.icod.techidon.api.requests.statuses.SetStatusPinned;
import de.icod.techidon.api.session.AccountLocalPreferences;
...
import de.icod.techidon.events.FollowRequestHandledEvent;
import de.icod.techidon.events.NotificationDeletedEvent;
import de.icod.techidon.events.RemoveAccountPostsEvent;
import de.icod.techidon.events.StatusDeletedEvent;
import de.icod.techidon.events.StatusUnpinnedEvent;
import de.icod.techidon.fragments.ComposeFragment;
import de.icod.techidon.fragments.HashtagTimelineFragment;
import de.icod.techidon.fragments.ProfileFragment;
import de.icod.techidon.fragments.ThreadFragment;
import de.icod.techidon.fragments.settings.SettingsServerFragment;
...
import de.icod.techidon.model.Searchable;
import de.icod.techidon.model.Status;
import de.icod.techidon.ui.M3AlertDialogBuilder;
import de.icod.techidon.ui.Snackbar;
import de.icod.techidon.ui.sheets.AccountSwitcherSheet;
import de.icod.techidon.ui.sheets.BlockAccountConfirmationSheet;
import de.icod.techidon.ui.sheets.MuteAccountConfirmationSheet;
import de.icod.techidon.ui.sheets.BlockDomainConfirmationSheet;
...
import de.icod.techidon.utils.Tracking;
...
//				.show();
	...
	public static void enablePopupMenuIcons(Context context, PopupMenu menu) {
		...
		// TECHIDON disable menu icons on android 14 and higher because of InsetDrawables breaking
	...
	public static Optional<String> extractPronouns(Context context, @Nullable Account account) {
		...
		return PronounHelper.extractPronouns(localizedPronouns, account);
	}
