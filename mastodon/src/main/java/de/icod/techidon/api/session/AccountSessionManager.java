...
import de.icod.techidon.ChooseAccountForComposeActivity;
...
import de.icod.techidon.api.requests.filters.GetLegacyFilters;
import de.icod.techidon.api.requests.instance.GetCustomEmojis;
import de.icod.techidon.api.requests.accounts.GetOwnAccount;
import de.icod.techidon.api.requests.instance.GetInstance;
import de.icod.techidon.api.requests.oauth.CreateOAuthApp;
import de.icod.techidon.events.EmojiUpdatedEvent;
...
public class AccountSessionManager{
	...
	public static String getRedirectURI() {
		...
		builder.append("techidon-android-");
