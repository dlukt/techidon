...
import de.icod.techidon.api.gson.IsoInstantTypeAdapter;
import de.icod.techidon.api.gson.IsoLocalDateTypeAdapter;
		...
		thread.postRunnable(()->{
			try{
				...
				Request.Builder builder=new Request.Builder()
						...
						.header("User-Agent", "TechidonAndroid/"+BuildConfig.VERSION_NAME);
