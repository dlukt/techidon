...
import de.icod.techidon.api.MastodonDetailedErrorResponse;
import de.icod.techidon.api.requests.accounts.RegisterAccount;
import de.icod.techidon.api.requests.oauth.CreateOAuthApp;
import de.icod.techidon.api.requests.oauth.GetOauthToken;
import de.icod.techidon.api.session.AccountActivationInfo;
