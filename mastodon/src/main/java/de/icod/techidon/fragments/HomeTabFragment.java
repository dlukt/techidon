...
import static de.icod.techidon.GlobalUserPreferences.reduceMotion;
...
import de.icod.techidon.api.requests.announcements.GetAnnouncements;
import de.icod.techidon.api.requests.lists.GetLists;
import de.icod.techidon.api.requests.tags.GetFollowedHashtags;
import de.icod.techidon.api.session.AccountSessionManager;
import de.icod.techidon.events.HashtagUpdatedEvent;
import de.icod.techidon.events.ListDeletedEvent;
import de.icod.techidon.events.ListUpdatedCreatedEvent;
import de.icod.techidon.events.SelfUpdateStateChangedEvent;
import de.icod.techidon.fragments.settings.SettingsMainFragment;
...
//	private ImageView toolbarLogo;
	...
	private void updateSwitcherIcon(int i) {
		...
		CharSequence title = timelines[i].getTitle(getContext());
		timelineIcon.setContentDescription(title);
		timelineTitle.setText(title);
		showFab();
