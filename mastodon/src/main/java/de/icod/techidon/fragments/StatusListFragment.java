...
import de.icod.techidon.events.EmojiReactionsUpdatedEvent;
import de.icod.techidon.events.PollUpdatedEvent;
import de.icod.techidon.events.ReblogDeletedEvent;
...
import de.icod.techidon.ui.displayitems.EmojiReactionsStatusDisplayItem;
...
public abstract class StatusListFragment extends BaseStatusListFragment<Status> {
	...
	protected List<StatusDisplayItem> buildDisplayItems(Status s){
		...
		/* TECHIDON: we make the filterContext null in the main status in the thread fragment, so that the main status is never filtered (because you just clicked on it).
